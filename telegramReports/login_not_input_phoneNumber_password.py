...
async def open_bebeclub():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.locator("input[placeholder='Masukkan Nomor HP Terdaftar']").click()
            report["steps"].append("Field Nomor HP berhasil diklik.")
            print("Field Nomor HP berhasil diklik.")
            
            await page.locator("input[placeholder='Masukkan Password Anda']").click()
            report["steps"].append("Field Password berhasil diklik.")
            print("Field Password berhasil diklik.")
            ...
            report["steps"].append(f"Button is disable?: {verify_button_disable}")
            print(f"Button is disable?: {verify_button_disable}")

            verify_error_phoneNumber = await page.locator("Nomor Handphone harus diisi").is_visible()
            report["steps"].append(f"Error message: {verify_error_phoneNumber}")
            print(f"Error message: {verify_error_phoneNumber}")

            verify_error_password = await page.locator("Password harus diisi").is_visible()
            report["steps"].append(f"Error message: {verify_error_password}")
            print(f"Error message: {verify_error_password}") 
